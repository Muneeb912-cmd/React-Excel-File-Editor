...
export const download = () => ({ type: EXPORT_DATA });
...
export default (state = initialState, action) => {
  switch (action.type) {
    ...
    case EXPORT_DATA: {
      ...
      const worksheet = XLSX.utils.aoa_to_sheet([headers.map(header => header.value)]);
      ...
      // Return the state as is, without modifying it
      return state;
    }
